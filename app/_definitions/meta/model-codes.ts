export const entitySingularCodes = [
  ...
  'mom_material_inventory',
  'mom_material_lot_warehouse_inventory',
  'mom_material_warehouse_inventory',
  'mom_package',
  'mom_package_good',
  'mom_process',
...
const entityFieldCodes = {
  ...
  'MomMaterialLotWarehouseInventory': [
    'id',
    'material',
    'tags',
    'lotNum',
